        ...
        <div class="contents">
          <div class="inner">
            ...
            <div class="board_write">
              <form name="writeFrm" method="post" action="../qna-board/edit.do"
               ...
               <div class="btn_wrap">
                 ...
                 <button type="button" onclick="location.href='../qna-board/list.do';" class="write_btn cancel_btn">목록</button>
               </div>
              </form>
            </div>
          </div>
