...
public class QnABoardViewController2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int totalCount = commentDAO.selectCountComm(map);
        ...
        List<CommentDTO> commentsList = commentDAO.selectListPageComm(map);
        commentDAO.close();
